...
C {vsource.sym} -280 30 0 0 {name=V1 value=0.7 savecurrent=false}
C {gnd.sym} -280 140 0 0 {name=l1 lab=0}
C {vsource.sym} -190 70 0 0 {name=V2 value="dc 0.700057 ac 1" savecurrent=false}
...
C {code_shown.sym} 110 -260 0 0 {name=SPICE only_toplevel=false value="
.control
op
run
